...
set(OSVRRM_REQUIRED_LIBRARIES osvr::osvrClientKit osvr::osvrClient osvr::osvrCommon osvr::osvrUtil)

set(OSVRRM_NEED_SDL2_COPIED @OSVRRM_NEED_SDL2_COPIED@)
if(OSVRRM_NEED_SDL2_COPIED)
	list(APPEND OSVRRM_REQUIRED_LIBRARIES SDL2::SDL2)
endif()

set(OSVRRM_NEED_GLEW_COPIED @OSVRRM_NEED_GLEW_COPIED@)
if(OSVRRM_NEED_GLEW_COPIED)
	list(APPEND OSVRRM_REQUIRED_LIBRARIES GLEW::GLEW)
endif()

include("${CMAKE_CURRENT_LIST_DIR}/CopyImportedTarget.cmake")
